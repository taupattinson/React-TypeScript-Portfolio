  // assets
  import homePageImg from "../assets/d1.jpg";
  import homePageIllustation from "assets/t2.jpg";
  ...
  const Hero = () => {
    return (
      <div
        ...
        style={{
          background: `url(${homePageImg}) center no-repeat`,
        ...
        >
          <div className="w-full xl:w-fit">
            ...
            >
              ...
              <a href="https://t.me/tauptaup" target="_blank" rel="noopener noreferrer">
                <Button icon={tele}>Telegram</Button>
              </a>
            </motion.div>
          </div>
